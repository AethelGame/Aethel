...
- Setup audio management using BASS
...
This project uses `GLFW`, `GLM`, and `freetype` as its dependencies through submodules. It also uses [BASS](https://www.un4seen.com/bass.html) and [GLAD](https://glad.dav1d.de/) with OpenGL 4.6 as dependencies outside of it.
